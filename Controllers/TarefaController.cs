...
namespace TrilhaApiDesafio.Controllers
{
    ...
    public class TarefaController : ControllerBase
    {
        ...
        [HttpGet("ObterTodos")]
        public IActionResult ObterTodos(int pagina = 1, int tamanhoPagina = 10)
        {
            var tarefas = _context.Tarefas
                                .Skip((pagina - 1) * tamanhoPagina)  // Pula os itens das páginas anteriores
                                .Take(tamanhoPagina)                 // Limita o número de itens retornados
                                .ToList();
        ...
        public IActionResult ObterPorTitulo(string titulo)
        {
            ...
            // Buscar tarefas no banco de dados com o título fornecido (case-insensitive)
            var tarefas = _context.Tarefas
        ...
        {
            // Busca as tarefas com o status fornecido
            var tarefas = _context.Tarefas
